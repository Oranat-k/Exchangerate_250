	...
	<div id="app">
		...
		<div class="container">
			<form class="cov-frm" name="frm" action="calculateResult.php" method="post" onsubmit="return myFunction()" >
				...
				<br><br><br>
				<button class="btn btn-warning btn-lg btn-block" type="submit">Calculate</button>
			</form>
